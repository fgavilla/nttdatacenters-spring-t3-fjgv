...
* The original package name 'com.example.nttdatacenters-spring-t3pr-fjgv' is invalid and this project uses 'com.example.nttdatacentersspringt3prfjgv' instead.
